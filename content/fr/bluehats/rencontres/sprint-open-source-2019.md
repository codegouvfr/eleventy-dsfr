---
title: "Premier sprint open source #BlueHats 🧢 de l’administration"
date: 2019-11-19
image:
  path: ./template-actu-numerique.png
  alt: Illustration pour l'événement BlueHats au Paris Open Source Summit 2019
description: La direction interministérielle du numérique (DINUM) et le 110 bis, le lab d’innovation de l’Éducation nationale, ont rassemblé la communauté BlueHats pour le premier sprint *open source* du secteur public les 19 et 20 novembre derniers.
---
...
{% imageContent "./sprint-montage.png", "Table ronde BlueHats" %}
...
{% imageContent "./sprint-photo-finale-hd-redim.jpg", "Table ronde BlueHats" %}
