...
Sur [code.etalab.gouv.fr](https://code.gouv.fr/sources), vous pouvez réduire la liste des dépôts à ceux qui sont hébergés dans une forge particulière et télécharger un fichier `csv` ne contenant que les dépôts de la vue filtrée que vous avez définie.
