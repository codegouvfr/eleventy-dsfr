---
title: Licences libres pour les codes sources publics et le socle interministériel de logiciels libres
...
Voir [la page dédiée](https://www.data.gouv.fr/fr/pages/legal/licences/) sur `data.gouv.fr`.
